...
import { TutorialDifficulty } from '@/lib/types'

const difficultyOptions: { value: TutorialDifficulty; label: string }[] = [
  { value: 'all', label: '全部' },
...
export default function GuidePage() {
  const [selectedDifficulty, setSelectedDifficulty] = useState<TutorialDifficulty>('all')
